...
import { ListOrdered, ShoppingBag, VenusAndMarsIcon } from 'lucide-react';
        ...
        <Container>
            <div className='mx-2 lg:mx-4 p-3'>
                ...
                <div className="col-span-12 3xl:col-span-9">
                    <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 bg-gradient-to-r from-transparent to-blue-50 border border-gray-50  shadow-sm py-10 px-4 rounded-lg">
                        <div className="col-span-12 sm:col-span-6 xl:col-span-4 2xl:col-span-3">
                            <div className="card border-0 p-4 shadow-sm shadow-blue-200 rounded-lg h-full bg-gradient-to-l from-blue-600/10 to-bg-white">
                                <div className="card-body p-0">
                                    <div className="flex flex-wrap items-center justify-between gap-1 mb-2">
                                        <div className="flex items-center gap-2">
                                            <span className="w-12 h-12 bg-charistan text-cyan-600 dark:text-cyan-600 flex-shrink-0 flex justify-center items-center rounded-full h6 mb-0">
                                                <ListOrdered className='stroke-white' />
                                            </span>
                                            <div>
                                                <h6 className="font-semibold mb-0.5 lg:text-lg text-blue-500">Total Order</h6>
                                                <span className="font-medium text-gray-600 text-sm lg:text-lg">
                                                    $1,752.42
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <p className="text-sm mb-0 text-gray-600">
                                        <span className="text-cyan-600 dark:text-cyan-600">4</span> Doctors
                                        joined this week
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="card border-0 p-4 shadow-sm shadow-blue-200 rounded-lg h-full bg-gradient-to-l from-blue-600/10 to-bg-white">
                                <div className="card-body p-0">
                                    <div className="flex flex-wrap items-center justify-between gap-1 mb-2">
                                        <div className="flex items-center gap-2">
                                            <span className="w-12 h-12 bg-charistan text-cyan-600 dark:text-cyan-600 flex-shrink-0 flex justify-center items-center rounded-full h6 mb-0">
                                                <SalesIcon className='fill-white size-6' />
                                            </span>
                                            <div>
                                                <h6 className="font-semibold mb-0.5 lg:text-lg text-blue-500">Total Revenue</h6>
                                                <span className="font-medium text-gray-600 text-sm lg:text-lg">
                                                    $1,752.42
                                                </span>
                                            </div>
                            ...
                            <div className="card border-0 p-4 shadow-sm shadow-blue-200 rounded-lg h-full bg-gradient-to-l from-blue-600/10 to-bg-white">
                                <div className="card-body p-0">
                                    <div className="flex flex-wrap items-center justify-between gap-1 mb-2">
                                        <div className="flex items-center gap-2">
                                            <span className="w-12 h-12 bg-charistan text-cyan-600 dark:text-cyan-600 flex-shrink-0 flex justify-center items-center rounded-full h6 mb-0">
                                                <VenusAndMarsIcon className='stroke-white' />
                                            </span>
                                            <div>
                                                <h6 className="font-semibold mb-0.5 lg:text-lg text-blue-500">Vendors</h6>
                                                <span className="font-medium text-gray-600 text-sm lg:text-lg">
                                                    $1,752.42
                                                </span>
                                            </div>
                                ...
                                <div className="card-body p-0">
                                    <div className="flex flex-wrap items-center justify-between gap-1 mb-2">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                <h6 className="font-semibold mb-0.5 lg:text-lg text-blue-500">Total Shops</h6>
                                                <span className="font-medium text-gray-600 text-sm lg:text-lg">
                                                    $1,752.42
                                                </span>
                                            </div>

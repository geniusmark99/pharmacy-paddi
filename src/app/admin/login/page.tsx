        ...
        <div className="flex h-screen items-center justify-center bg-gray-100">
            ...
            <div className="m-auto w-full max-w-[420px] rounded-xl border p-5 sm:p-8 shadow-sm bg-white">
                <div className="mb-2 flex  flex-col justify-center items-center text-center">
                    <p className='text-center md:text-base font-semibold tracking-wide mt-2 text-transparent bg-clip-text bg-gradient-to-r from-charistan to-emerald-400'>Admin Login</p>

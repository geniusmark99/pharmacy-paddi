    ...
    return (
        <Container>
            <div className='mx-2 lg:mx-4 p-3'>
                <div>
                    <div className="rounded bg-white p-5 shadow md:p-8 mb-8 flex flex-col items-center justify-between md:flex-row">
                        ...
                        <div className="flex w-full flex-col items-center ms-auto md:w-1/2 md:flex-row">
                            ...
                            >
                                ...
                                <input
                                    ...
                                    id="search"
                                    name="searchText"
                                    className="ps-10 pe-4 h-12 flex items-center w-full rounded-md appearance-none 
                                    transition duration-300 ease-in-out text-heading text-sm focus:outline-none 
                                    focus:ring-0 border border-1 border-gray-200 focus:border-blue-600"
                    ...
                    <div className=''>
                        {/* Table Section */}
                        <div className="px-4 py-10 sm:px-6  mx-auto bg-white">
                            <div className="flex flex-col">
                                <div className="-m-1.5 overflow-x-auto">
                                    <div className="p-1.5 min-w-full inline-block align-middle">
                                        <div className="border border-gray-200 rounded-xl shadow-2xs overflow-hidden  ">
